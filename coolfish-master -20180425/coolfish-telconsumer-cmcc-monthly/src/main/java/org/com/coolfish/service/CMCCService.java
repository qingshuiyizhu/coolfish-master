...
public class CMCCService {
     ...
     * 请求参数 telnum:号码 req_seq:流水号
     */
    public String queryStatus(String telnum, String req_seq, String appId, String token, String groupid) {
        // 报文
     ...
     * 请求参数
     */
    public String tfjActionXml(String telnum, String oprtype, String reason, String appid, String token,
            String groupid) {
     ...
     */
    public String queryDankaXml(String service_number, String cycle, String req_seq, String appid,
            String token) {
