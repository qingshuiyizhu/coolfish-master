package org.com.coolfish.ctccstoperror;
...
//电信月套餐队列
@Component
@RabbitListener(queues = "ctcc-stoperror")
public class MQReceiver {
    ...
    public void process(String message) {
        ...
        logger.info("电信停机队列(ctcc-stoperror)获取数据[{}]", message);
    ...
    public void handleMessage(MsisdnMessage msisdnMessage) {
        ...
        if (null == operator) {
            ...
            logger.info("[{}]调用电信停机服务,运营商账号信息：{}", msisdnMessage.getTel(), operator.toString());
            // 调用停机服务
            ctccRestService.disabledNumberController(operator, msisdnMessage);
        }
    }
