...
public class KuyuCard extends IdEntity implements Serializable {
   ...
   //
    ...
    public KuyuCard(Long id,Integer operator_type, String tel, Integer operatorid, Integer zid, BigDecimal sumflow,
            BigDecimal useflow, BigDecimal per, Integer card_status, Integer type,Integer frequency,Integer store) {
        super();
        this.setId(id); 
        this.operator_type = operator_type;
        this.tel = tel;
