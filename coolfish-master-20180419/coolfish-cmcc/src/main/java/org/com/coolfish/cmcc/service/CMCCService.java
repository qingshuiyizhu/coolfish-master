...
public class CMCCService {
	...
	public void test1() {
		try {
			// DKLLCXQuery("17892088908", 201803, "0_9834345");
			DTLLCQuery("0", "51210000736", "201803", "0_9834345");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public String UserstatuscontrolQuery(String msisdn, String SUB_SERVICE_STATUS, String service, String oprtype) {
		...
		return CommonSend(operationIn, desc, UserstatuscontrolOperationIn.class);
	}
	...
	public String QryuserQuery(String telnum, String req_seq) {
		...
		return CommonSend(operationIn, desc, QryuserOperationIn.class);
	}
	...
	public String QrystatusQuery(String telnum, String req_seq) throws Exception {
		...
		return CommonSend(operationIn, desc, QrystatusOperationIn.class);
	}
	...
	public String QrycycleQuery(String telnum, String req_seq) throws Exception {
		...
		return CommonSend(operationIn, desc, QrycycleOperationIn.class);
	}
	...
	public String SuspendtestQuery(String telnum) throws Exception {
		...
		return CommonSend(operationIn, desc, SuspendtestOperationIn.class);
	}
	...
	public String QryuserinfoQuery(String ddr_city, String msisdn, String req_seq){
		...
		return CommonSend(operationIn, desc, QryuserinfoOperationIn.class);
	}
	...
	public String SLLZXJGQuery(String ddr_city, String orderid, String req_seq)  {
		...
		return CommonSend(operationIn, desc, SLLZXJGOperationIn.class);
	}
	...
	public String TFJQuery(String telnum, String oprtype, String reason) {
		...
		return CommonSend(operationIn, desc, TFJOperationIn.class);
	}
	...
	public String DKLLCXQuery(String service_number, Integer cycle, String req_seq)   {
		...
		// 请求类型
		operationIn.setReq_type("1");
		return CommonSend(operationIn, desc, DKLLCXOperationIn.class);
	}
	...
	public String DTLLCQuery(String qrytype, String eccode, String cycle, String req_seq) {
		...
		// 请求类型
		operationIn.setReq_type("1");
		return CommonSend(operationIn, desc, DTLLCOperationIn.class);
	...
	public String CommonSend(Object operationIn, String desc, Class<?> clazz) {
		...
		String json = "";
		try {
			String result = new XMLHttpPost().sendXMLHttpPost(param.getUrl(), xml.toString());
