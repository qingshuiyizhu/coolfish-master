...
public class CMCCService {
	 ...
	 */
	public String TFJQuery(String telnum, String oprtype, String reason) throws Exception {
	...
	public Future<String> DKLLCXQuery(String service_number, String cycle, String req_seq){
