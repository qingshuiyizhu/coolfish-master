...
public class CMCCService {
     ...
     */
    public String querySllzxjg(String ddr_city, String orderid, String req_seq) {
     ...
     */
    public String tfjAction(String telnum, String oprtype, String reason,String appid,String token,String groupid) {
    ...
    public String tfjAction(String telnum, String oprtype, String reason) {
        String desc = "物联网集团成员停复机:" + "号码为：" + telnum + ",操作类型:" + oprtype + ",reason:操作原因:" + reason;
        logger.info(desc);
        // 报文
        TFJOperationIn operationIn = new TFJOperationIn();
     ...
     */
    public String queryDkllcx(String service_number, String cycle, String req_seq,String appid,String token) {
    ...
    public String queryDkllcx(String service_number, Integer cycle, String req_seq) {
        String desc = "物联网单卡实时流量查询:" + "查询号码为：" + service_number + ",查询月数为:" + cycle + ",req_seq:请求流水号:"
                + req_seq;
        logger.info(desc);
        // 报文
     ...
     * 
     */
    public String queryDtllc(String qrytype, String eccode, String cycle, String req_seq) {
